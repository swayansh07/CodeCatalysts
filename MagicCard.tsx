...
const DEFAULT_GLOW_COLOR = '66, 133, 244'; // Primary blue
...
export const MagicCard = ({
  ...
  return (
    <div
      ref={cardRef}
      className={`magic-bento-card particle-container ${className}`}
...
export const MagicCardContainer = ({ children, className = '' }: any) => {
